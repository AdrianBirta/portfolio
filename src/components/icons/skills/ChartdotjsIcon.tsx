...
export default function ChartjsIcon({ size = 24, color = "#FF6384", className }: IconProps) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
